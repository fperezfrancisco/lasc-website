...
export default function About() {
    ...
    return (
        <div  className={`flex flex-col w-full max-w-[2000px] mx-auto my-0 h-full min-h-screen text-text`}>
            <Header />
            {/* About section starts here */}
            <main className="mt-12 w-full flex flex-col gap-5 px-4">
                <section className="w-full flex flex-col items-center gap-5 mb-12">
                    <h1 className="w-fit text-center text-4xl font-bold mb-4 border-b-4 border-white px-4 py-2">About Us</h1>
                    <PictureAndPara 
                ...
                <section className="w-full flex flex-col mb-12 items-center gap-12">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        <h4 className={`${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Board and Staff</h4>
                        <h2 className="text-2xl lg:text-3xl font-extrabold uppercase text-text">Executive Board Members</h2>
                    </div>
                    ...
                    <h2 className="text-2xl lg:text-3xl font-extrabold uppercase text-text">2025/26 Club Directors</h2>
                    ...
                    <h2 className="text-2xl lg:text-3xl font-extrabold uppercase text-text">2025/26 Coaching Staff</h2>
                    <div className="w-fit grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center mb-6">
