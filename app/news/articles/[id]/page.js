        ...
        <main className="w-full h-full grid grid-cols-1 lg:grid-cols-3 gap-8 px-10 md:px-15 pb-24">
            <section className="lg:col-span-2 flex flex-col">
                ...
                <div className="flex flex-col gap-2 mb-6">
                    <h4 className="text-center text-xs md:text-lg text-blue-400">#Hashtag</h4>
                    <h1 className="text-center text-4xl md:text-5xl font-semibold">LASC Boys 2018 Take Cup Home!</h1>
                    <h6 className="text-center text-sm md:text-md text-gray-600 dark:text-gray-300">By Author Here</h6>
                </div>
                ...
                <div className="relative w-full h-full aspect-3/4 sm:aspect-video min-h-[300px] md:max-h-[700px] rounded-[8px] bg-neutral-200 overflow-hidden mb-12">
                    ...
                    <div className="w-full col-span-2 flex flex-col gap-4">
                        ...
                        "Everyone said we were the underdogs today, but we showed them why they were wrong!"
                        </span>
