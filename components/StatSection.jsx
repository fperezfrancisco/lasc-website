...
const StatSection = () => {
  return (
    <div className="w-full px-4 lg:px-6 py-[48px] md:py-[64px] lg:py-[96px] flex flex-col-reverse lg:flex-row gap-4 md:gap-8 md:gap-10 xl:gap-18 items-center overflow-hidden">
      <BannerLascTheme>
        <div className="w-full h-full grid grid-cols-1 min-[350px]:grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 justify-between text-white items-center z-10">
